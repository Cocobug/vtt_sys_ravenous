...
export class EntitySheetHelper {
  ...
  static onAttributeRoll(event) {
    ...
    const shorthand = game.settings.get("vtt_sys_ravenous", "macroShorthand");
  ...
  static async createDialog(data={}, options={}) {
    ...
    const templates = collection.filter(a => a.getFlag("vtt_sys_ravenous", "isTemplate"));
    ...
    const useEntity = game.vtt_sys_ravenous.useEntity;
    ...
    return Dialog.prompt({
      ...
      callback: html => {
        ...
        if ( template ) {
          ...
          delete createData.flags.vtt_sys_ravenous.isTemplate;
        }
